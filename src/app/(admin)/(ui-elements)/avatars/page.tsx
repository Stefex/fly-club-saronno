...
export const metadata: Metadata = {
  title: "Fly Angling Club Saronno Avatars | TailAdmin - Fly Angling Club Saronno Dashboard Template",
  description:
    "This is Fly Angling Club Saronno Avatars page for TailAdmin - Fly Angling Club Saronno Tailwind CSS Admin Dashboard Template",
};
