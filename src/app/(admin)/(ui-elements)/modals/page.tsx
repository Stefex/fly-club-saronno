...
export const metadata: Metadata = {
  title: "Fy Angling Club Saornno Modals | TailAdmin - Fy Angling Club Saornno Dashboard Template",
  description:
    "This is Fy Angling Club Saornno Modals page for TailAdmin - Fy Angling Club Saornno Tailwind CSS Admin Dashboard Template",
  // other metadata
};
